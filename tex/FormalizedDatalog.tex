...
Rules and programs can be transformed in straightforward way. Here we use lists to model the body as a fixed order of the atoms simplifies later algorithms.
