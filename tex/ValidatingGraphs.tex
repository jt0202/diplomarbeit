...
We did not manage to verify the \lstinline|ofList| operation that takes a list of pairs of the type $A \times B$ and converts it into a \lstinline|HashMap A B|