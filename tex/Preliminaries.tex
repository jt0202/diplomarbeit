...
In the example, some atoms used only constants in their terms, while others included variables. This is expressed by $Vars(A(t_1,...,t_n)) = \{t_i \mid t_i \in V\}$. If for some atom $a$ $Vars(a)$ is empty, we call this a \textit{ground atom}.
