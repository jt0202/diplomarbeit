...
\begin{document}
   \maketitle
    ...
    I want to thank my advisors Lukas Gerlach and Dr. Stephan Mennicke for introducing Lean and the problem to me and their helpful comments during the creation of this thesis. Lukas also improved my previous graph model in \cref{sec:valGraph} by adding the hash map implementation.
